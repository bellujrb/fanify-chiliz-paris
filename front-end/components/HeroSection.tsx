        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-2">
              <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                ...
                <div className="text-gray-900">of fan engagement</div>
            ...
            <p className="text-lg text-gray-600 leading-relaxed max-w-xl">
              Fanify turns real fan sentiment into prediction tokens using the power of Twitter and Chiliz — the global leader in fan tokens.
            </p>
            ...
            <div className="grid grid-cols-3 gap-8 pt-8">
              <div>
                ...
                <div className="text-sm text-gray-600">Fans Active on Social Media</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-gray-900">70%</div>
                <div className="text-sm text-gray-600">Want More Interactive Experiences</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-gray-900">$450M+</div>
                <div className="text-sm text-gray-600">Fan Token Market</div>
              </div>
            </div>
          ...
          <div className="relative">
            <div className="relative w-full h-[600px] lg:h-[700px]">
              ...
              <div className="absolute inset-0 flex items-center justify-center z-10">
                <div className="relative">
                  <Image
                    ...
                    width={500}
                    height={650}
                    className="mx-auto max-h-[70vh] max-w-[90%] object-contain object-top relative z-10 mt-[-30px]"
                    priority
                  />
              ...
              <div className="absolute bottom-20 left-40 w-12 h-12 bg-gradient-to-r from-red-500/80 to-red-500 rounded-lg transform rotate-12 animate-pulse shadow-lg z-20 flex items-center justify-center">
